...
class AppStateNotifier extends ChangeNotifier {
  ...
  // Avoid blocking the app indefinitely if auth stream fails to emit on web.
      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: SubscriptWidget.routeName,
              path: SubscriptWidget.routePath,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'subscript')
                  : SubscriptWidget(),
            ),
            FFRoute(
              name: Sub2Widget.routeName,
              path: Sub2Widget.routePath,
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'AboutApp')
                  : AboutAppWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: RadarWidget.routeName,
              path: RadarWidget.routePath,
              requireAuth: true,
              builder: (context, params) => const RadarWidget(),
            ),
            FFRoute(
