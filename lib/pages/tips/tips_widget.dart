              ...
              RichText(
                ...
                text: TextSpan(
                  children: [
                    TextSpan(
                      text:
                          'Το «Cached»  είναι απλά ένα on/off switch που λέει στο FlutterFlow:\nON → «φτιάξε αυτόματα ένα CachedNetworkImage» (δηλαδή η εικόνα κατεβαίνει μία φορά, αποθηκεύεται στον δίσκο της συσκευής και την επόμενη φορά δεν ξανακατεβαίνει).\nOFF → «χρησιμοποίησε απλό Image.network» (κατεβαίνει κάθε φορά που ανοίγει η οθόνη).\n\n',
