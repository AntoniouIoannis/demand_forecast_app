...
class _Auth2WidgetState extends State<Auth2Widget>
  ...
  void initState() {
    ...
    _model.txtFieldEmailCreateFocusNode ??= FocusNode();
    ...
    _model.txtFieldMobilehponeTextController ??= TextEditingController();
    _model.txtFieldMobilehponeFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    ...
    final baseCardHeight = screenSize.width >= 1200.0
        ? 600.0
        : screenSize.width >= 768.0
            ? 680.0
            : 730.0;
    final topOffset = screenSize.height < 820.0 ? 110.0 : 170.0;
    final authCardHeight = (screenSize.height - topOffset - 28.0)
        .clamp(460.0, baseCardHeight)
        .toDouble();
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: Image.asset(
                            'assets/images/earth-galaxy-elements-this-image-furnished-by-nasa.jpg',
                          ).image,
                        ),
                      ...
                      child: Padding(
                        ...
                        child: GradientText(
                          ...
                          style: FlutterFlowTheme.of(context)
                            ...
                            shadows: [
                              Shadow(
                                color: Color(0xF22721BF),
                                offset: Offset(19.0, 12.0),
                                blurRadius: 3.0,
                              )
                            ],
                          ),
                          colors: [Color(0xFF2F2302), Color(0xFFFBFB02)],
                                  ...
                                  Align(
                                    ...
                                    child: TabBar(
                                      ...
                                      labelStyle: FlutterFlowTheme.of(context)
                                        ...
                                        shadows: [
                                          Shadow(
                                            color: Color(0xFF145A8F),
                                            offset: Offset(05.0, 6.0),
                                            blurRadius: 1.0,
                                          )
                                        ],
                                      ),
                                      ...
                                      controller: _model.tabBarDuoController,
                                      onTap: (i) async {
                                        [() async {}, () async {}][i]();
                                      },
                                    ),
