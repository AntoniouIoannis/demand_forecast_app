...
import 'sub2_model.dart';
export 'sub2_model.dart';

class Sub2Widget extends StatefulWidget {
  const Sub2Widget({super.key});

  static String routeName = 'sub2';
  static String routePath = 'sub2';

  @override
  State<Sub2Widget> createState() => _Sub2WidgetState();
}

class _Sub2WidgetState extends State<Sub2Widget> with TickerProviderStateMixin {
  late Sub2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Sub2Model());
